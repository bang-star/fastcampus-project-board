...
class ArticleControllerTest {
    ...
    @DisplayName("[view][GET] 게시글 페이지 - 인증 없을 때는 로그인 페이지로 이동")
    @Test
    ...
    @WithUserDetails(value = "artistTest", setupBefore = TestExecutionEvent.TEST_EXECUTION)
