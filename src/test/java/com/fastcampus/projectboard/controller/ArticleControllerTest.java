...
class ArticleControllerTest {
    ...
    @DisplayName("[view][GET] 게시글 리스트 (게시판) 페이지 - 검색어 함께 호출")
    @Test
    ...
    @Test
    void givenPagingAndSortingParams_whenRequestingArticlePage_thenReturnsArticlesView() throws Exception {
        // Given
    ...
    @Test
    void givenNothing_whenRequestingSearchArticleView_thenReturnsSearchArticleView() throws Exception {
        // Given
